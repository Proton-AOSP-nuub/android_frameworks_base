...
@Module
public abstract class SystemUIProtonBinder extends SystemUIBinder {
    /**
     * Inject into ProtonServices.
     */
    @Binds
    @IntoMap
    @ClassKey(ProtonServices.class)
    public abstract SystemUI bindProtonServices(ProtonServices sysui);
