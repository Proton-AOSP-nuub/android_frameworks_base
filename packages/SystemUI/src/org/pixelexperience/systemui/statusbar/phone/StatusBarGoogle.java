...
public class StatusBarGoogle extends StatusBar {
    ...
    public StatusBarGoogle(Context context,
        ...
        super(context, notificationsController, fragmentService, lightBarController, autoHideController,
                ...
                statusBarTouchableRegionManager, notificationIconAreaController, brightnessSliderFactory, chargingRippleAnimationController, wallpaperController,
                ...
                burnInProtectionController, refreshNavbarHandler);
